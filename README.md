...
- **Inspection** — expandable Locals / Globals scopes, watch expressions with change tracking, expression console with DAP tab-completion
...
| `g` | Cycle Locals / Globals scope (Locals panel) |

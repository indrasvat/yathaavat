...
class YathaavatApp(App[None]):
    ...
    BINDINGS: ClassVar[list[BindingType]] = [
        ...
        Binding("f5", "command('debug.continue')", "Continue", priority=True),
        Binding("f10", "command('debug.step_over')", "Step Over", priority=True),
        Binding("f11", "command('debug.step_in')", "Step In", priority=True),
        Binding("f12", "command('debug.step_out')", "Step Out", priority=True),
